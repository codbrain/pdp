...
$opt_name = 'stellaroption';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__('Stellar Options', 'your-textdomain-here'),

	// The text to appear on the page title.
	'page_title'                => esc_html__('Stellar Options', 'your-textdomain-here'),
