...
class Elementor_Cta_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Cta Stellar', 'elementor-stellar');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Donec imperdiet consequat consequat. Suspendisse feugiat congue
                                        posuere. Nulla massa urna, fermentum eget quam aliquet.', 'elementor-stellar'),
        ...
        <section id="cta" class="main special">
            ...
            <footer class="major">
                <ul class="actions special">
                    <li><a href="<?php echo $settings['link_primary']; ?>" class="button primary"><?php esc_html_e('Get Started', 'elementor-stellar'); ?></a></li>
